      ...
      <div className="text-gray-700 text-xl">
        <p>
          ...
          <a
            href="/faq"
            target="_blank"
            className="text-[#8DC044] underline w-full break-all"
          >
            https://www.londonwastemanagement.com
          </a>
        </p>
        ...
        <p>
          We may share your personal data with external third parties who may
          use your data to inform their legitimate interests and/or marketing
          practices. We insist that any third party companies respect the
          security of your personal data and that they treat it in accordance
          with the law. We respect your right to withhold consent. Please select
          this box to opt out of data sharing.
        </p>
        <h2 className="text-3xl font-semibold text-[#8DC044] mt-12 mb-4">
        ...
        <p>
          ...
          see, edit, or delete their personal information at any time (however,
