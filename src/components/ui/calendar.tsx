  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-[#8CC044] text-primary-foreground hover:bg-[#8CC044] hover:text-primary-foreground focus:bg-[#8CC044] focus:text-white rounded-full",
...
export default function DatePicker() {
  ...
  return (
    <div className="border rounded-lg shadow-lg w-fit">
      <Calendar
        mode="single"
        selected={date}
        onSelect={setDate}
